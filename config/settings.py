...
# Necesario para que WhiteNoise (y `collectstatic`) sirvan los
# estáticos detrás de waitress, que no los sirve por sí mismo como sí
# lo hace `manage.py runserver` en desarrollo.
